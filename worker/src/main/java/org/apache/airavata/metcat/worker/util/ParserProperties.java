...
public class ParserProperties {
    ...
    public static final String PARSER_PROPERTY_FILE = "../conf/metcat-parser.properties";
    public static final String DEFAULT_PARSER_PROPERTY_FILE = "conf/metcat-parser.properties";
    ...
    private ParserProperties() {
        try {
            ...
            if (new File(PARSER_PROPERTY_FILE).exists()) {
                ...
                logger.info("Using configured parser property (metcat-parser.properties) file");
            } else {
                logger.info("Using default parser property (metcat-parser) file");
