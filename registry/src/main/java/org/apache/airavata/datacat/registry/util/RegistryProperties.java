...
public class RegistryProperties {
    ...
    public static final String REGISTRY_PROPERTY_FILE = "../conf/datacat-registry.properties";
    public static final String DEFAULT_REGISTRY_PROPERTY_FILE = "conf/datacat-registry.properties";
    ...
    private RegistryProperties() {
        try {
            ...
            if (new File(REGISTRY_PROPERTY_FILE).exists()) {
                ...
                logger.info("Using configured registry property (datacat-registry.properties) file");
            } else {
                logger.info("Using default registry property (datacat-registry) file");
